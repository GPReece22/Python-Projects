...
print("Number of heavy goods vehicles seen:", heavy_vehicles)
print("Number of light good vehicles seen:", light_vehicles)
print("Number of private cars seen:", private_cars)
